...
def positive_assert(first_name):
    ...
    # El resultado de la solicitud de recepción de datos de la tabla "user_model" se guarda en la variable
...
def negative_assert_symbol(first_name):
    ...
    assert response.json()[
               "message"] == ("Has introducido un nombre de usuario no válido. El nombre solo puede contener letras "
                              "del alfabeto latino, la longitud debe ser de 2 a 15 caracteres.")
